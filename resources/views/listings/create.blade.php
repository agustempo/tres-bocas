<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">{{ __('ui.create_listing') }}</h2>
    </x-slot>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <form method="POST" action="{{ route('listings.store') }}">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <a href="{{ route('listings.index') }}" class="text-sm text-gray-500 hover:underline">{{ __('ui.cancel') }}</a>
                    </div>
                </form>
